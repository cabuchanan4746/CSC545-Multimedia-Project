...
void setup() {
  ...
  bold = createFont("Bitstream Charter Bold", 18);
...
void draw() {
  ...
  String title = "There Was An Old Lady Who Swallowed A Fly";
  textFont(bold);
  String play_all = "Click here to play all!";
  String verse = "Click each button to hear a different verse";
  fill(0,255,0);
  textFont(font);
  text(title, 500, 35);
  fill(0,0,0);
  ...
  img[9] = loadImage("stop_sign.png");
  img[9].loadPixels();
  image(img[9], stopX, stopY, buttonSideSize, buttonSideSize);
 


  //Images for the main screen (playall button)
  if (playAll) {
    ...
    //FLY:
    if (currentPlayTime >= 2 && currentPlayTime <= 10 || currentPlayTime >= 15 && currentPlayTime <= 18 || currentPlayTime > 30 && currentPlayTime <= 35 || currentPlayTime > 50 && currentPlayTime <= 54 || currentPlayTime > 72 && currentPlayTime <= 75 || currentPlayTime >= 95 && currentPlayTime <= 97 || currentPlayTime > 120 && currentPlayTime <= 124 ) {
    ...
    //SPIDER:
    else if (currentPlayTime > 10 && currentPlayTime < 15 || currentPlayTime >= 28 && currentPlayTime <= 30 || currentPlayTime > 45 && currentPlayTime <= 50  || currentPlayTime >= 67 && currentPlayTime <= 72 || currentPlayTime > 88 && currentPlayTime < 95 || currentPlayTime >= 114 && currentPlayTime <= 120) {
    ...
    //Bird:
    else if (currentPlayTime >= 21 && currentPlayTime < 28 || currentPlayTime > 42 && currentPlayTime <= 45 || currentPlayTime > 63 && currentPlayTime < 67 || currentPlayTime >= 87 && currentPlayTime <= 88 || currentPlayTime > 112 && currentPlayTime < 114 ) {
    ...
    //CAT:
    else if (currentPlayTime >= 38 && currentPlayTime <= 42 || currentPlayTime >= 61 && currentPlayTime <= 63 || currentPlayTime >= 85 && currentPlayTime < 87 || currentPlayTime > 110 && currentPlayTime <= 112 ) {
    ...
    //DOG:
    else if (currentPlayTime >= 58  && currentPlayTime < 61 || currentPlayTime >= 83 && currentPlayTime < 85 || currentPlayTime > 109 && currentPlayTime <= 110) {
    ...
    //GOAT:
    else if (currentPlayTime >= 79  && currentPlayTime < 83 || currentPlayTime >= 107 && currentPlayTime <= 109 ) {
    ...
    //COW:
    else if (currentPlayTime >= 102  && currentPlayTime < 107 ) {
    ...
    //HORSE:
    else if (currentPlayTime >= 127  && currentPlayTime <= 128) {
    ...
    //GRAVE:
    else if (currentPlayTime > 128  && currentPlayTime <= 130) {
      img[8] = loadImage("graveE.png");
      img[8].loadPixels();
      image(img[8], playAllX, playAllY, 200, 200);      
    }
    ...
    textFont(bold);
    textSize(20);
    text(play_all, playAllX+buttonSideSize/1.2, playAllY+220);
  }
}//end draw()
